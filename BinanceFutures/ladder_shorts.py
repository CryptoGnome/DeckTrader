...
binance.create_limit_sell_order(symbol + '/USDT', size * 0.025, price, params={"newClientOrderId": create_string()})
binance.create_limit_sell_order(symbol + '/USDT', size * 0.05, price2 , params={"newClientOrderId": create_string()})
binance.create_limit_sell_order(symbol + '/USDT', size * 0.10, price3, params={"newClientOrderId": create_string()})
binance.create_limit_sell_order(symbol + '/USDT', size * 0.30, price4, params={"newClientOrderId": create_string()})
binance.create_limit_sell_order(symbol + '/USDT', size * 0.55, price5, params={"newClientOrderId": create_string()})
